...
export const FAQ_ITEMS: IFaqItem[] = [
  ...
  },
  {
    ...
    answer: `Reach out to us at <a href="mailto:contact@zlend.fi" style="color: #006AFE;font-weight: 600;text-decoration: none;">contact@zlend.fi</a> or join our community on <a href="https://discord.gg/VJkXvVKWfp" target="_blank" rel="noopener noreferrer" style="color: #006AFE;font-weight: 600;text-decoration: none;">Discord</a> for assistance.`,
    theme: 'Additional Information'
  }
];